...
const MainHeader = () => {
    ...
    const headerClasses = "sticky top-0 z-50 lg:mx-9 lg:translate-y-5 transition-all duration-300";
    const containerClasses = "hidden lg:block w-full px-2.5 lg:px-9 py-0.5 rounded-full bg-neutral-400/40 text-zinc-900 backdrop-blur-sm backdrop-saturate-200";
